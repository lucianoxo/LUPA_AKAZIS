...
<html>
    ...
    <body>
        ...
        <main>
            <div class="main_hero container boxs">
                <div class="banner">
                    <ul>
                        ...
                        <li><img src="img/slider-bg-5.jpg" class="responsive-img"></li>
                        <li><img src="img/slider-bg-1.jpg" class="responsive-img"></li>
                    </ul>
                </div>
            </div>
            ...
            <!--            <div class="main_newsletter container">
                            <div class="content row">
                                <div class="main_newsletter_title col l4 m4 s12">
        ...
        <footer class="main_footer container">
            <div class="content">
                ...
                <div class="main_fotter_box">
                    ...
                    <ul>
                        <li>Rua Augusto Calheiros, Centenário - Caruaru/PE</li>
                        <li>(81) 99926-9111</li>
                        <li>atendimento@akazis.com.br</li>
                    </ul>
                </div>
            </div>
        </footer>
